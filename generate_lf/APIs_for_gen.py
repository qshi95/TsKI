...
#                 "tostr": lambda t, col, value : "within_s_s{{{}; {}; {}}}".format(t, col, value),
#                 'append': None}

# APIs['within_n_n'] = {"argument":['row', 'header_num', 'num'], 'output': 'bool',
#                 "function": lambda t, col, value : len(t[t[col] == value]) > 0,
#                 "tostr": lambda t, col, value : "within_n_n{{{}; {}; {}}}".format(t, col, value),
#                 'append': None}
...
#                           "tostr": lambda t, col, value : "not_within_s_s{{{}; {}; {}}}".format(t, col, value),
#                           'append': None}

# APIs['not_within_n_n'] = {"argument":['row', 'header_num', 'num'], 'output': 'bool',
#                           "function": lambda t, col, value : len(t[t[col] == value]) == 0,
#                           "tostr": lambda t, col, value : "not_within_n_n{{{}; {}; {}}}".format(t, col, value),
#                           'append': None}
...
APIs['several'] = {"argument":['row'], 'output': 'bool',
                "function": lambda t: len(t) > 1,
                "tostr": lambda t : "several{{{}}}".format(t),
                'append': None}
...
# APIs['exist'] = {"argument":['row'], 'output': 'bool',
#                 "function": lambda t: len(t) > 0,
...
APIs['uniq_num'] = {"argument":['row', 'header_num'], 'output': 'num',
              ...
              "tostr": lambda t, col : "uniq_num{{{}; {}}}".format(t, col),
              'append': True}

APIs['uniq_str'] = {"argument":['row', 'header_str'], 'output': 'num',
              "function": lambda t, col : len(t[col].unique()),
              "tostr": lambda t, col : "uniq_str{{{}; {}}}".format(t, col),
              'append': True}
...
APIs['str_hop'] = {"argument":['row', 'header_str'], 'output': 'str', 
               'function': lambda t, col : ', '.join([str(item) for item in t[col].values]),
               'tostr': lambda t, col : "str_hop{{{}; {}}}".format(t, col),
               'append': True}
